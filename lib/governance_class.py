...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to piond "gobject list" output
    ...
    def piond_serialise(self):
        import pionlib
        return pionlib.SHIM_serialise_for_piond(self.serialise())
