...
sentinel_cfg = PionConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_piond_proto_version_with_sentinel_ping = 70207


def get_pion_conf():
    home = os.environ.get('HOME')

    pion_conf = os.path.join(home, ".pioncore/pion.conf")
    if sys.platform == 'darwin':
        pion_conf = os.path.join(home, "Library/Application Support/PionCore/pion.conf")

    pion_conf = sentinel_cfg.get('pion_conf', pion_conf)
